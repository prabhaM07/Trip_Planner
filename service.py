...
# def get_route(coordinates: list, api_key: str, max_distance_km: float = 500):
...
#         if response.status_code == 404 and "routable point" in response.text:
#             raise Exception(
#                 "Location is not near any roads. "
#                 "Please provide a more specific city name instead of a state or region. "
...
#         geometry = [decoded_coords[0], decoded_coords[-1]]
#     else:
